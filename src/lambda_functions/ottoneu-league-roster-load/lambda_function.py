...
def lambda_handler(event, context):
    ...
    try:
        ...
        return {'statusCode': 400, 'body': json.dumps('Body does not have search_name parameter.')}
    if not lg_id:
        return {'statusCode': 400, 'body': json.dumps('Empty string passed as search name')}
    ...
    return {'statusCode': 200, 'body': json.dumps(roster_dict)}
